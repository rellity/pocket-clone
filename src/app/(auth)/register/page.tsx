...
export default function SignUp() {
  return (
    <div className="flex max-h-[910px] max-w-full flex-col">
      <div className="flex sm:py-28">
        <div className="mx-auto flex w-full max-w-2xl flex-col px-4 sm:px-6">
          <Link href={routes.home}>
            <svg viewBox="0 0 106 40" className="mx-auto h-10 w-auto">
              <svg
                viewBox="0 0 40 40"
                width="40"
                height="40"
          ...
          <div className="relative mt-12 sm:mt-16">
            ...
            <p className="mt-3 text-center text-lg text-gray-600">
              Already registered?{' '}
              <Link className="text-cyan-600" href={routes.login}>
                Sign in{' '}
              </Link>
              to your account.
            </p>
          </div>
          <div className="-mx-4 mt-10 flex-auto bg-white px-4 py-10 shadow-2xl shadow-slate-900/15 sm:mx-0 sm:flex-none sm:rounded-2xl sm:p-24">
            <form>
              <div className="grid grid-cols-2 gap-6">
                ...
                <Select>
                  <SelectTrigger className="col-span-full">
                    <SelectValue placeholder="AltaVista search" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup className="block w-full appearance-none rounded-lg border border-gray-200 bg-white px-[calc(theme(spacing.3)-1px)] py-[calc(theme(spacing.2)-1px)] pr-8 text-gray-900 placeholder:text-gray-400 focus:border-cyan-500 focus:outline-none focus:ring-cyan-500 sm:text-sm">
                      <SelectItem value="AltaVista search">
                        AltaVista search
                      </SelectItem>
                      <SelectItem value="Super Bowl commercial">
                        Super Bowl commercial
                      </SelectItem>
                      <SelectItem value="Our route 34 city bus ad">
                        Our route 34 city bus ad
                      </SelectItem>
                      <SelectItem value="The “Never Use This” podcast">
