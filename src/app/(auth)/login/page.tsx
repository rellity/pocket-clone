        ...
        <div className="mx-auto flex w-full max-w-2xl flex-col px-4 sm:px-6">
          ...
          <div className="relative mt-12 sm:mt-16">
            ...
            <p className="mt-3 text-center text-lg text-gray-600">
              ...
              <Link className="text-cyan-600" href={routes.register}>
                Sign up{' '}
              </Link>
              for a free trial.
            </p>
          </div>
          <div className="shadow-black-900/10 -mx-4 mt-10 flex-auto rounded-2xl bg-white px-4 py-10 shadow-2xl sm:mx-0 sm:flex-none sm:p-24">
            <form>
