...
export default function FeatureSection(props: Props) {
  ...
  return (
    <section
      className="overflow-hidden bg-gray-900 py-20 sm:py-32"
      id={props.id}
    >
      ...
      <div className="mt-16 md:hidden">
        <div className="-mb-4 flex snap-x snap-mandatory -space-x-4 overflow-x-auto overscroll-x-contain scroll-smooth pb-4 [scrollbar-width:none] sm:-space-x-6">
          <div className="w-full flex-none snap-center px-4 sm:px-6">
            <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <svg viewBox="0 0 558 558" width="558" height="558" fill="none">
                  <defs>
                    <linearGradient
                      id=":Rapbqnla:"
                      x1="79"
              ...
              <div className="relative mx-auto aspect-[366/729] w-full max-w-[366px]">
                  ...
                  <div className="flex w-full flex-col">
                    ...
                    <div className="mt-6 px-4 text-white">
                      ...
                      <div className="text-sm text-gray-500">
                        Get tips <span className="text-white">5s sooner</span>
                        for every invite.
                      </div>
                    </div>
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gray-800/90 backdrop-blur max-sm:p-10 max-sm:pt-3 sm:p-10">
                ...
                <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                  <div className="flex w-full flex-col">
                    ...
                    <div className="mt-6 px-4 text-white">
                      ...
                      <div className="text-sm text-gray-500">March 9, 2022</div>
                    </div>
                    <div className="mt-6 flex-auto rounded-t-2xl bg-white">
                      <div className="divide-y divide-gray-100">
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#F9322C]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#5A67D8]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#2A5B94]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#3320A7]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              stroke="#fff"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#2A3034]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#0EA5E9]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#16A34A]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="#fff"
                              className="h-10 w-10"
                        ...
                        <div className="flex items-center gap-4 px-4 py-3">
                          <div className="flex-none rounded-full bg-[#8D8D8D]">
                            <svg
                              viewBox="0 0 40 40"
                              fill="none"
                              stroke="#fff"
      ...
      <Tab.Group
        ...
        defaultIndex={0}
        as="div"
        className="mx-auto hidden max-w-7xl px-4 sm:px-6 md:mt-20 md:block lg:px-8"
      >
        <div className="grid grid-cols-12 items-center gap-8 lg:gap-16 xl:gap-24">
          ...
          >
            <Tab.List>
              <Tab
                as="div"
                className="relative rounded-2xl transition-colors hover:bg-gray-800/30 ui-selected:outline-none"
              >
                <div
                  className={`absolute inset-0 rounded-[16px] bg-gray-800 ${activeTab == 0 ? 'opacity-1' : 'opacity-0'}`}
                ></div>
                ...
                <div className="relative z-10 p-8">
                  ...
                  <h3 className="z-0 mt-6 text-lg font-semibold text-white">
                    <button className="text-left ui-selected:outline-none">
              ...
              >
                <div
                  className={`absolute inset-0 rounded-[16px] bg-gray-800 ${activeTab == 1 ? 'opacity-1' : 'opacity-0'}`}
                ></div>
                <div className="relative z-10 p-8">
                  <svg viewBox="0 0 32 32" className="h-8 w-8">
                    <circle
              ...
              >
                <div
                  className={`absolute inset-0 rounded-[16px] bg-gray-800 ${activeTab == 2 ? 'opacity-1' : 'opacity-0'}`}
                ></div>
                <div className="relative z-10 p-8">
                  <svg viewBox="0 0 32 32" fill="none" className="h-8 w-8">
                    <defs>
                  ...
                  <h3 className="mt-6 text-lg font-semibold text-white">
                    <button
                      className="-z-1 text-left ui-not-focus-visible:outline-transparent"
                      type="button"
                    >
                      <span className="absolute inset-0 rounded-2xl"></span>
                      Invest what you want
          ...
          <div className="relative col-span-6">
            ...
            <div className="relative z-10 mx-auto aspect-[366/729] w-full max-w-[366px]">
              ...
              <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                <Tab.Panels
                  as="div"
                  className="z-0 col-start-1 row-start-1 flex outline-transparent"
                >
                  <div className="flex w-full flex-col">
                    <div className="flex justify-between px-4 pt-4">
                      <svg
                    ...
                    <Tab.Panel as="div" className="flex-auto">
                      <div className="opacity-1 mt-6 px-4 text-white ui-selected:animate-fade-in ui-not-selected:animate-fade-out">
                        <div className="text-2xl text-white">Invite people</div>
                        <div className="text-sm text-gray-500">
                          Get tips <span className="text-white">5s sooner</span>
                          for every invite.
                      ...
                      <div className="mt-6 flex-auto scale-100 transform rounded-t-2xl bg-white blur-none delay-0 ui-selected:animate-height-expand ui-not-selected:scale-75">
                        <div className="px-4 py-6 pb-[18.6rem] ui-selected:origin-bottom ">
                          <div className="space-y-6">
                            <div>
                              <div className="text-sm text-gray-500">
                                Full name
                    ...
                    <Tab.Panel>
                      <div className="opacity-1 mt-6 px-4 text-white ui-not-checked:animate-fade-out ui-selected:animate-fade-in">
                        <div className="text-2xl text-white">Stocks</div>
                        <div className="text-sm text-gray-500">
                          March 9, 2022
                        </div>
                      </div>
                      <div className="mt-6 flex-auto rounded-t-2xl bg-white ui-selected:animate-height-expand ui-not-selected:scale-75">
                        <div className="divide-y divide-gray-100">
                          <div className="flex items-center gap-4 px-4 py-3">
                            <div className="flex-none rounded-full bg-red-500">
                              <svg
                                viewBox="0 0 40 40"
                                fill="#fff"
                                aria-hidden="true"
                          ...
                          <div className="flex items-center gap-4 px-4 py-3">
                            <div className="flex-none rounded-full bg-[#5b67d6]">
                              <svg
                                viewBox="0 0 40 40"
                                fill="#fff"
                                aria-hidden="true"
                          ...
                          <div className="flex items-center gap-4 px-4 py-3">
                            <div className="flex-none rounded-full bg-[#3220a7]">
                              <svg
                                viewBox="0 0 40 40"
                                fill="#fff"
                                stroke="#fff"
                          ...
                          <div className="flex items-center gap-4 px-4 py-3">
                            <div className="flex-none rounded-full bg-[#0ea4e9]">
                              <svg
                                viewBox="0 0 40 40"
                                fill="#fff"
                                aria-hidden="true"
                    ...
                    <Tab.Panel>
                      <div className="mt-6 px-4 text-white ui-selected:animate-fade-in">
                        <div className="text-2xl text-white">Buy $LA</div>
                        <div className="text-sm text-gray-500">
                          <span className="text-white">$34.28</span> per share
                        </div>
                      </div>
                      <div className="mt-6 flex-auto rounded-t-2xl bg-white ui-selected:animate-height-expand">
                        <div className=" px-4 py-6 pb-80">
                          <div className="space-y-4">
                            <div className="flex justify-between border-b border-gray-100 pb-4">
                              <div className="text-sm text-gray-500">
                                Number of shares
              ...
              <Image
                ...
                decoding="async"
                data-nimg="1"
                className="pointer-events-none absolute inset-0 h-full w-full fill-transparent opacity-0"
                src="https://pocket.tailwindui.com/_next/static/media/phone-frame.d4b6b62a.svg"
              />
            </div>
          </div>
