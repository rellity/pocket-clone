...
export default function Header() {
  return (
    <header className="top-0 z-50 w-full bg-gray-50">
      <div
        className="relative z-50 mx-auto flex max-w-7xl justify-between px-4 py-8 sm:px-6 lg:px-8"
        tabIndex={-1}
      >
        <div className="relative z-10 flex items-center gap-16">
          <Link href={routes.home}>
            <svg viewBox="0 0 106 40" className="h-10 w-auto">
              <svg
                viewBox="0 0 40 40"
                width="40"
                height="40"
          ...
          <div className="hidden lg:flex lg:gap-10">
            <Button
              ...
              className="relative -mx-3 -my-2 rounded-lg bg-transparent px-3 py-2 text-sm text-gray-700 shadow-none transition-colors delay-150 hover:bg-slate-200/80 hover:text-gray-900 hover:delay-0"
            >
        ...
        <div className="max-lg:flex lg:items-center lg:gap-10">
          <Disclosure
            as="nav"
            className="max-lg:flex lg:items-center lg:gap-10"
          >
            <div className="flex items-center gap-6">
              <div className="lg:hidden">
                <Disclosure.Button className="relative z-10 -m-2 inline-flex items-center overflow-hidden rounded-lg bg-transparent stroke-gray-900 p-2 shadow-none hover:bg-gray-200/50 hover:stroke-gray-600 focus:outline-none active:stroke-gray-900">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    className="h-6 w-6 ui-not-open:hidden"
                  >
                    <path
                      d="M17 14l-5-5-5 5"
                      strokeWidth="2"
                  ...
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    className="h-6 w-6 ui-open:hidden"
                  >
                    <path
                ...
                <Transition
                  enter="fixed inset-0 z-0 transition duration-250 ease-out"
                  enterFrom="transform translate-y-[-100px] opacity-0"
                  enterTo="transform-transition opacity-100 ease-in"
                  leave="fixed inset-0 z-0 transition duration-250 ease-out"
                  leaveFrom="transform-none opacity-100 ease-in"
                  leaveTo="transform translate-y-[-100px] opacity-0"
                >
                  <div className="absolute inset-0 z-0">
                    <div className="opacity-1 fixed inset-0 z-0 bg-gray-300/60 backdrop-blur"></div>

                    <div className="relative inset-x-0 top-0 z-0 rounded-b-2xl bg-gray-50 px-6 pb-6 pt-32 shadow-2xl shadow-gray-900/20">
                      <div className="space-y-4 ui-not-open:top-0">
                        <a
                      ...
                      <div className="mt-8 flex flex-col gap-4">
                        ...
                        <a
                          className="inline-flex justify-center rounded-lg bg-gray-800 px-3 py-2 text-sm font-semibold text-white outline-2 outline-offset-2 transition-colors hover:bg-gray-900 active:bg-gray-800 active:text-white/80"
                          color="gray"
                          href="#"
                        >
                          Download the app
        ...
        <div className="flex items-center gap-6 max-lg:hidden">
          <Link
            className="hidden justify-center rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-700 outline-2 outline-offset-2 transition-colors hover:border-gray-400 hover:bg-gray-50/80 active:bg-gray-100 active:text-gray-700/80 lg:block"
            href={routes.login}
          >
            Log in
          </Link>
          ...
          <Link
            className="hidden justify-center rounded-lg bg-gray-800 px-3 py-2 text-sm font-semibold text-white outline-2 outline-offset-2 transition-colors hover:bg-gray-900 active:bg-gray-800 active:text-white/80 max-lg:hidden lg:block"
            href="#"
          >
            Download
          </Link>
